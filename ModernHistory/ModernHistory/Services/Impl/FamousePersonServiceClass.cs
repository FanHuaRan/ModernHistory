...
namespace ModernHistory.Services.Impl
{
    ...
    public class FamousePersonServiceClass : IFamousePersonService
    {
        ...
        public static readonly string FindUrl = WebApiConfig.WEBAPI_BASE_Uri+"/FamousPerson/Get";

        public static readonly string SaveUrl = WebApiConfig.WEBAPI_BASE_Uri+"/FamousPerson/Save";

        public static readonly string UpdateUrl = WebApiConfig.WEBAPI_BASE_Uri+"/FamousePerson/Update";

        public static readonly string SearchUrl = WebApiConfig.WEBAPI_BASE_Uri+"/Famouse/Person/Search";

        public static readonly string DeleteUrl = WebApiConfig.WEBAPI_BASE_Uri+"/FamousePerson/Delete";
